...
function moduleItemText(t: TFunction, id: DashboardModuleId): { label: string; descr: string } {
  const MODULE_TEXT: Record<DashboardModuleId, { label: string; descr: string }> = {
    ...
    panelMezzi: { label: t("userProfileSettingsPage.module.panelMezzi.label"), descr: t("userProfileSettingsPage.module.panelMezzi.descr") },
    panelRefill: { label: t("userProfileSettingsPage.module.panelRefill.label"), descr: t("userProfileSettingsPage.module.panelRefill.descr") },
