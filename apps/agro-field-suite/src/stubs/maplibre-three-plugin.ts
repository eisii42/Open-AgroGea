/**
 * Stub di `@dvt3d/maplibre-three-plugin` per l'app di campo.
 *
 ...
 * grafo del modulo, e three.js è pesante e con addon che il bundler non
 ...
 * componente restano inerti: se mai venissero invocate (non accade in campo)
