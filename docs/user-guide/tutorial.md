# AgroGea — Tutorial: dal primo avvio all'uso quotidiano
...
>
> Se cerchi la descrizione di riferimento delle funzioni (non i passaggi), vedi il [Manuale Utente](./client-manual.md).
...
> Per la spiegazione di riferimento delle singole funzioni vedi il [Manuale Utente](./client-manual.md); per gli aggiornamenti automatici il documento [Desktop Auto-Update](../technical/desktop-auto-update.md).
