...
function HistogramChart({
  ...
  if (!result)
    return <EmptyChart message="No numeric values to plot." />;
...
function ScatterChart({
  ...
  if (!result) {
    return (
      <EmptyChart message="No rows have both fields set to a number." />
    );
  }
...
function PieChart({
  ...
  if (!result)
    return <EmptyChart message="No positive values to chart." />;
